Garages = {
    ...
    ["sapcounsel"] = {
        ...
        takeVehicle = vector3(-328.66, -753.63, 33.25),
        spawnPoint = vector4(-328.66, -753.63, 33.25, 72.57),
        putVehicle = vector3(-328.66, -753.63, 33.25),
        showBlip = true
    },
    ["spanishave"] = {
    ...
    ["caears242"] = {
        label = "Caears 24 Parking",
        takeVehicle = vector3(-463.54, -819.56, 30.56),
        spawnPoint = vector4(-463.54, -819.56, 30.56, 359.88),
        putVehicle = vector3(-463.54, -819.56, 30.56),
        showBlip = true
    },
    ["caears242"] = {
        label = "Caears 24 ParkingInside",
        takeVehicle = vector3(-462.63, -760.73, 30.56),
        spawnPoint = vector4(-462.63, -760.73, 30.56, 3.36),
        putVehicle = vector3(-462.63, -760.73, 30.56),
        showBlip = false
    },
    ["lagunapi"] = {
    ...
    ["MissionRowParkingOutside"] = {
        label = "Mission Row",
        takeVehicle = vector3(444.92, -1048.4, 28.54),
        spawnPoint = vector4(444.92, -1048.4, 28.54, 316.04), 
        putVehicle = vector3(444.92, -1048.4, 28.54),
        showBlip = false
    },
    ["MissionRowParkingInside"] = {
        label = "Mission Row",
        takeVehicle = vector3(426.63, -973.05, 25.7),
        spawnPoint = vector4(426.63, -973.05, 25.7, 16.84), 
        putVehicle = vector3(426.63, -973.05, 25.7),
        showBlip = false
    },
    ["BCSO"] = {
        label = "BCSO",
        takeVehicle = vector3(1851.18, 3674.93, 33.05),
        spawnPoint = vector4(1851.18, 3674.93, 33.05, 35.14), 
        putVehicle = vector3(1851.18, 3674.93, 33.05),
        showBlip = false
    },
    ["StatePolice"] = {
        label = "State Police Parking",
        takeVehicle = vector3(-457.83, 6026.66, 30.62),
        spawnPoint = vector4(-457.8, 6026.64, 30.62, 144.5), 
        putVehicle = vector3(-457.83, 6026.66, 30.62),
        showBlip = false
    },
    ["pillboxgarage"] = {
